...
public partial class Resonance : ResoniteMod
{
    ...
    [Range(0f, 0.95f)]
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<float> smoothing = new(
        "FFT Smoothing",
    ...
    [Range(0f, 96f, "0db")]
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<float> noisefloor = new(
        "Noise Floor",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<float> gain = new(
        "Gain",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<bool> autogain = new(
        "Auto Gain",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<bool> hiresfft = new(
        "High-Resolution FFT",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<bool> lowlatencyaudio = new(
        "Low-Latency Audio",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<int> visiblebins = new(
        "Visible bins",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<float> autogainspeed = new(
        "Auto Gain Speed",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<bool> QUANTIZE_BINS = new(
        "Quantize bins",
    ...
    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<int> HIGH_RESOLUTION_FFT_OVERRIDE = new(
        "Hi-Res FFT override",
    ...
    public static int High_Resolution_Fft_Override =>
        (int)Math.Pow(2, Math.Ceiling(Math.Log(Config!.GetValue(HIGH_RESOLUTION_FFT_OVERRIDE), 2))); // Ensure a power of 2

    [AutoRegisterConfigKey]
    public static readonly ModConfigurationKey<bool> NORMALIZE_FFT = new(
        "FFT Normalization",
    ...
    private static void NORMALIZE_FFT_changed(object? obj)
    {
        ...
        foreach (var handler in VideoStreamHandler.FFTDict.Values)
            handler.SetNormalized((bool)obj!);
    }
    ...
    public static void HandleEvents()
    {
        ...
        lowlatencyaudio.OnChanged += o =>
            RunInAllWorldsSynchronously(() => Lowlatencyaudio_changed(o));
